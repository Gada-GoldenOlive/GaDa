...
import { DrawingManager, Map, useMap } from "react-kakao-maps-sdk";
const { kakao } = window;

const DrawPolylineFromKakao = ({ path }) => {
  const map = useMap();
  ...
  //   level: 3, // 지도의 확대 레벨
  // };
  //var map = new kakao.maps.Map(mapContainer); // 지도를 생성합니다
...
export default DrawPolylineFromKakao;
{
  /*
